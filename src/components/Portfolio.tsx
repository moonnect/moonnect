          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            ...
            <div className="space-y-16">
              ...
              <motion.div 
                ...
                className="p-10 rounded-[2rem] bg-white/5 border border-white/10 relative group overflow-hidden"
              >
                          ...
                          >
                           ...
                           >
                             ...
                             <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center gap-2.5 backdrop-blur-sm">
                               ...
                               {item.videoUrl && (item.videoUrl.includes('instagram') || item.videoUrl.startsWith('http')) && (
                                 <Button 
                                   className="bg-pink-600 hover:bg-pink-700 text-white font-bold tracking-widest text-[10px] px-6 py-3 h-auto rounded-xl border-pink-500/20 flex items-center justify-center gap-1.5 min-w-[140px]"
                                   onClick={(e) => {
                                     e.stopPropagation();
                                ...
                                <Button 
                                  ...
                                  className={`${
                                    item.videoUrl.includes('instagram') 
                                      ? 'bg-pink-600 hover:bg-pink-700 border-pink-500/20' 
                                      : 'liquid-glass border-white/20'
                                  } text-white font-bold tracking-widest text-[10px] px-8 py-4 h-auto rounded-xl flex items-center gap-1.5`}
                                >
                                  {item.videoUrl.includes('instagram') ? (
                                    <>
                                      <Instagram size={12} />
              ...
              {selectedGalleryItem.videoUrl && (selectedGalleryItem.videoUrl.includes('instagram') || selectedGalleryItem.videoUrl.startsWith('http')) && (
                <div className="mt-6">
                  <Button 
                    ...
                    className="bg-pink-600 hover:bg-pink-700 text-white font-bold tracking-widest text-xs px-6 py-3.5 h-auto rounded-xl border border-pink-500/20 flex items-center gap-1.5 w-fit"
                  >
                    <Instagram size={14} />
                    <span>Instagram 바로가기</span>
                  </Button>
